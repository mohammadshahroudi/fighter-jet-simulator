Shader "Custom/Terrain8LayerURP_LitVersion"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                // Deadline-safe fallback: if the bridge has not written _LayerCount yet,
                // still draw the first 7 layers instead of returning black.
                int layerCount = (_LayerCount <= 0) ? 7 : _LayerCount;
                ...
                // Manual simple lighting. Keeping SRPDefaultUnlit makes this render like
                // your working shader, while still giving mountain sides light/dark shape.
                Light mainLight = GetMainLight();
                half ndotl = saturate(dot(normalWS, mainLight.direction));

                // Small floor so terrain does not disappear during night or weak ambient.
                half3 ambient = max(SampleSH(normalWS) * 0.25, half3(0.08, 0.08, 0.08));
